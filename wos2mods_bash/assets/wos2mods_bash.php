#!/usr/bin/env php
        ...
        //
        // THIS SCRIPT WRITTEN TO RUN THROUGH SHELL WITH 1 ARGUMENT FOR
        // PATH TO JSON TXT FILE. OUTPUT GOES TO /output/ SUBDIRECTORY
        //
        //

        if(empty($argv[1])){
            echo "Missing path to JSON txt file";
            exit();
        }
        ...
        $output = fopen($handle,"w") or die ("Could not open $handle");
